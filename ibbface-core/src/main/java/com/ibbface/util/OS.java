...
public enum OS {
    ...
    /** iphone OS 6。*/
    IOS_6(34, "iPhone OS", "6.x"),

    /** iphone OS 7。*/
    IOS_7(35, "iPhone OS", "7.x"),
    ...
    /** Windows Phone 8.*/
    WINDOWS_PHONE_8(42, "Windows Phone OS", "8"),
    ...
    public boolean isIPhoneOS() {
        return this == IOS || this.getIndex() >= IOS_3.getIndex() ||
                this.getIndex() <= IOS_6.getIndex();
    }
