...
CREATE CACHED TABLE IBB_CHILD (
  ...
  LUNAR_BIRTH VARCHAR(50) NULL,
  CONSTELLATION_ID SMALLINT NULL,
  ZODIAC_ID SMALLINT NULL,
  BLOOD_TYPE_ID SMALLINT NULL,
  AVATAR_URI VARCHAR(200) DEFAULT NULL,
  SMALL_AVATAR_URI VARCHAR(200) DEFAULT NULL,
  THUMB_AVATAR_URI VARCHAR(200) DEFAULT NULL
);

CREATE CACHED TABLE IBB_APP_CLIENT (
  ID INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1001) NOT NULL PRIMARY KEY,
  CLIENT_SECRET VARCHAR(50) NOT NULL,
  TYPE_CODE SMALLINT NOT NULL,
  VERSION VARCHAR(10) NOT NULL,
  VERSION_NAME VARCHAR(20) NULL,
  UPGRADE_CONTENT VARCHAR(1000) NOT NULL,
  DOWNLOAD_URLS VARCHAR(500) NULL,
  INCOMPATIBLE_DATA VARCHAR(500) NULL,
  IS_STABLE TINYINT DEFAULT 1 NOT NULL,
